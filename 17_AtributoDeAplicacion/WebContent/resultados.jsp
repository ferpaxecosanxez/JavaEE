...
<body>
	<%
		...
		// De aplicación. Aquí si que verificamos que no sea null porque el usuario puede acceder directamente a
		// los resultados sin pasar por el servlet y ello implica que no se ha ejecutado el método init aún.
