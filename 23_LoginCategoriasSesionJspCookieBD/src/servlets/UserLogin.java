...
public class UserLogin extends HttpServlet {
	 ...
	 * 
	 * @param response Argumento que viene desde el método service(), se corresponde
	 *                 con el objeto de la cabecera de la petición.
	 * @param valor    Nombre de usuario que se va ha almacenar.
	 */
